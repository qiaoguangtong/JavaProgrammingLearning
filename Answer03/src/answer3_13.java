...
public class answer3_13 {
	public static void main(String[] args) {
		Scanner input = new Scanner(System.in);
		System.out.println("(0-single filer, 1-married jointly or "
				+ "qualifying window(er), 2-married separately, 3-head of " + "household) \nEnter the filing status: ");
		...
		if (status == 0) {
			...
			if (income <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28
						+ (375950 - 171550) * 0.33 + (income - 372950) * 0.35;
		} else if (status == 1) {
			...
			if (income <= 16700)
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (372950 - 137050) * 0.28
						+ (income - 372950) * 0.33;
			else
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28
						+ (375950 - 171550) * 0.33 + (income - 372950) * 0.35;
			...
			if (income <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
						+ (375950 - 104425) * 0.33 + (income - 186475) * 0.35;
			...
			if (income <= 11950)
				...
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28
						+ (375950 - 190200) * 0.33 + (income - 372950) * 0.35;
